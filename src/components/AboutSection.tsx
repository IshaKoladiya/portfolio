                  ...
                  <div className="w-[39%] max-md:ml-0 max-md:w-full">
                    <div className="flex items-start self-stretch my-auto w-full text-2xl font-semibold text-black max-md:mt-10">
                      ...
                      <img
                        ...
                        alt=""
                        className="object-contain shrink-0 self-start aspect-[1.11] w-[31px]"
                      />
                    </div>
                  </div>
                  <div className="ml-5 w-[61%] max-md:ml-0 max-md:w-full">
                    <img
                      src="https://api.builder.io/api/v1/image/assets/TEMP/bfe53ebd969046c37afc3fb1d5c01d73aadde476?placeholderIfAbsent=true&apiKey=f2d3014bc7054ec3aa77eed737369b56"
                      alt="Design showcase"
                      className="object-contain grow w-full aspect-[1.49] max-md:mt-10"
                    />
                  </div>
                </div>
              </div>
